...
**Supported browsers**
* IE8, IE9 and early versions of IE 11 (before 11.413.15063.0) are **not** supported by the Admin portal.
* It is recommended that users access the Admin portal using Chrome or Firefox, or latest versions of IE.
