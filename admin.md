...
* SCAS to advise how temporary passwords should be communicated to users
...
* SCAS to advise of appropriate channels for communicating new passwords (i.e. not email)
...
* User will need to ensure they have an Authenticator App installed on their smart phone - 
search for \"Google Authenticator\" in the relevant application store for their smartphone (Apple / Andriod / etc.)
...
* This element of the Admin Portal is restricted to very limited, high privileged users
* SCAS to agree on who can access this
* If restricted to HSCIC DevOps / TechOps then suggest training notes will not be included just a note on the function of this feature.
